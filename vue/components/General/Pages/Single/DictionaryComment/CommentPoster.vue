<template>
    <div v-if="!isHidePoster">
        ...
        <div class="user-commenter-container flex" :class="[containerClass]">
            ...
            <div class="user-comment-input-container" :class="[{'is-invalid-data': isInValid}]">
                <div class="user-comment-input">
                    ...
                    <textarea :ref="`poster-${_uid}`" @click="enterTextPoster" @blur="leaveTextPoster"
                              v-model="text"
                              rows="3"
                              class="textarea" :class="poster.class">{{text}}</textarea>
                </div>
            </div>
