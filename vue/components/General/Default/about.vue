        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="about-image mt-50">
              <img :src="`${baseUrl}/images/about/about-2.jpg`" alt="About">
            </div>
            <!-- about imag -->
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="singel-counter text-center mt-40">
              <span>
                <span class="counter">41,000</span>+
              </span>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="singel-counter text-center mt-40">
              <span>
                <span class="counter">11,000</span>+
              </span>
              <p>People certifie</p>
            </div>
            <!-- singel counter -->
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="singel-counter text-center mt-40">
              <span>
                <span class="counter">39,000</span>+
              </span>
              <p>Global Teachers</p>
            </div>
            <!-- singel counter -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="singel-teachers mt-30 text-center">
              <div class="image">
                <img :src="`${baseUrl}/images/teachers/t-5.jpg`" alt="Teachers">
              </div>
              <div class="cont">
                <a href="teachers-singel.html">
                  <h6>Mark alen</h6>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="singel-teachers mt-30 text-center">
              <div class="image">
                <img :src="`${baseUrl}/images/teachers/t-6.jpg`" alt="Teachers">
              </div>
              <div class="cont">
                <a href="teachers-singel.html">
                  <h6>Mark alen</h6>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="singel-teachers mt-30 text-center">
              <div class="image">
                <img :src="`${baseUrl}/images/teachers/t-7.jpg`" alt="Teachers">
              </div>
              <div class="cont">
                <a href="teachers-singel.html">
                  <h6>Mark alen</h6>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="singel-teachers mt-30 text-center">
              <div class="image">
                <img :src="`${baseUrl}/images/teachers/t-8.jpg`" alt="Teachers">
              </div>
              <div class="cont">
                <a href="teachers-singel.html">
                  <h6>Mark alen</h6>
